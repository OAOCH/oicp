...
const METHODOLOGY = {
  ...
  banderas: {
    ...
    'IC-02': { nombre: 'Alto valor sin competencia', peso: 30, regla: 'procurement_method == "direct" y monto > umbral de la FECHA del proceso (no del año: hay corte el 7-oct-2025). monto = adjudicado, o presupuesto si no hay adjudicado. AVISO: incluye órdenes de catálogo electrónico, que el SERCOP publica como "direct" y son ~60% de sus disparos, aunque las banderas CC-* sí excluyen el catálogo. La rama por texto "ínfima" no dispara nunca: el método del SERCOP no contiene esa palabra.' },
